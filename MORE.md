...
If you don't want to rely on [unpkg.com](https://unpkg.com/#/about), save [the file](https://unpkg.com/vanilla-back-to-top@7.1.4/dist/vanilla-back-to-top.min.js) to your project and serve it from your server:
```html
