...
[![No Dependencies](http://svgshare.com/i/4rU.svg)](https://github.com/vfeskov/vanilla-back-to-top/blob/v7.1.12/package.json)
[![File Size](https://unpkg.com/vanilla-back-to-top@7.1.12/size-shield.svg)](https://github.com/vfeskov/vanilla-back-to-top/blob/v7.1.12/dist/vanilla-back-to-top.min.js.gz)
...
[<img src="https://i.pi.gy/O1Gbz.png" width="67" /><img src="https://i.pi.gy/8Z0Nj.png" width="54"><img src="https://i.pi.gy/0P8Nr.png" width="120"><img src="https://i.pi.gy/Vabg0.png" width="72">](https://github.com/vfeskov/vanilla-back-to-top/blob/v7.1.12/EXAMPLES.md)<br/>
...
- Works great with [Vue](https://vuejs.org/), [React](https://reactjs.org/), [Angular](https://angular.io/) and other frameworks, see [INSTALL](https://github.com/vfeskov/vanilla-back-to-top/blob/v7.1.12/INSTALL.md)
...
```html
<script src="https://unpkg.com/vanilla-back-to-top@7.1.12/dist/vanilla-back-to-top.min.js"></script>
<script>addBackToTop({
  diameter: 56,
...
```
For alternative installation see [INSTALL](https://github.com/vfeskov/vanilla-back-to-top/blob/v7.1.12/INSTALL.md)

See [EXAMPLES](https://github.com/vfeskov/vanilla-back-to-top/blob/v7.1.12/EXAMPLES.md)

For all options see [OPTIONS](https://github.com/vfeskov/vanilla-back-to-top/blob/v7.1.12/OPTIONS.md)

## License

MIT, see [LICENSE](https://github.com/vfeskov/vanilla-back-to-top/blob/v7.1.12/LICENSE)
